...
public class HomeInventory extends JFrame {
  ...
  public void WindowClosing(WindowEvent event)
  {
	  ...
	  gridConstraints.fill=gridConstraints.VERTICAL;
	  ...
	  inventoryToolBar.addSeparator();
	   ...
	   itemTextField.setText("Inventory Item");
	   ...
	   photoTextArea.setBorder(BorderFactory.createLineBorder(Color.BLACK,1));
	   gridConstraints = new GridBagConstraints();
	   gridConstraints.gridx = 2;
	   gridConstraints.gridy = 6;
	  ...
	  Dimension screenSize =
			...
			// open file for entries 
			  try
			{
			BufferedReader inputFile = new BufferedReader(new FileReader("D:\\mySelf\\java training\\Home Inventory Application\\inventory.txt"));
			numberEntries =
